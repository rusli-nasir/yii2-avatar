      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-header">
              ...
              <h4 class="modal-title" id="avatar-modal-label"><?= Yii::t('app','Upload Avatar')?></h4>
          </div>
          <div class="modal-body">
              <div class="avatar-body">
                ...
                <div class="avatar-upload">
                  ...
                  <label for="avatarInput"><?= Yii::t('app','Upload Local')?>：</label>
                ...
                <div class="row avatar-btns">
                  <div class="col-md-3">
                    <button type="submit" class="btn btn-hyii btn-block avatar-save"><?= Yii::t('app','Upload')?></button>
                  </div>
                </div>
              </div>
          </div>
